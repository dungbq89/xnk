            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide roomthumb"><img
                            src="<?php echo VtHelper::getPathImage($room['image_path'], sfConfig::get('app_product_images', 'products')) ?>"
                            width="100%"/></div>

                    <?php if ($listImage) {
                        foreach ($listImage as $img) {
                            $path = '/uploads/' . sfConfig::get('app_product_images') . $img['image_path'];
                            ?>
                            <div class="swiper-slide roomthumb"><img
                                    src="<?php echo VtHelper::getThumbUrl($path, 125, 80, 'default') ?>"
                                    width="100%"/></div>
                            <?php
                        }
                    } ?>
