<div class="well pull-left margin-right">
  <div class="btn-group">
                    <button type="submit" class="btn btn-success" name="batch_action" value="batchDelete" id="batchDelete" onclick="$(this).addClass('clicked')" ><?php echo __('Delete', array(), 'messages') ?></button>      </div>
