...
<?php include_partial('adManageCategory/assets') ?>
<?php include_partial('adManageCategory/header') ?>
...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <?php include_partial('adManageCategory/list_sidebar', array('configuration' => $configuration)) ?>
        <?php endif; ?>
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <?php include_partial('adManageCategory/flashes') ?>

            <div id="sf_admin_content">

                <form class="form-inline" id="list-form" action="<?php echo url_for('ad_category_collection', array('action' => 'batchList')) ?>" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="padding: 5px">
                                    <?php include_partial('adManageCategory/list_actions', array('helper' => $helper)) ?>
                                </div>
                                <div style="padding: 5px">
...
<?php include_partial('adManageCategory/footer') ?>
