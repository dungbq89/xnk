<div class="sf_admin_list">
    <table class="datatable table table-bordered table-striped" id="table_vt_manage_services_detail" style="margin-top: 5px !important;">
      <thead>
          ...
          <?php include_partial('adAlbum/list_th_tabular_detail', array('sort' => $sort)) ?>
      ...
      <!--   End thongnq1   -->
        <?php foreach ($results as $i => $ad_photo): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          ...
          <tr class="sf_admin_row <?php echo $odd ?> {pk: <?php echo $ad_photo->getId() ?>}" rel="<?php echo $ad_photo->getId() ?>">
                ...
                <?php  include_partial('adAlbum/list_td_tabular_detail', array('ad_photo' => $ad_photo, 'orderNo' => $orderNo,'ad_album' => $ad_album)) ?>
      ...
      <tfoot>
        <tr>
          <th colspan="7">
            ...
            <div style="position: relative; width: auto; float:right"><?php include_partial('adAlbum/pagination_detail', array('pager' => $pager,'ad_album' => $ad_album)) ?></div>
