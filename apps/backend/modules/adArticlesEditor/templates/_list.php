    ...
    <table class="datatable table table-bordered table-striped" id="table_vt_manage_articles" style="margin-top: 5px !important;">
        ...
        <tr>
            ...
            <th id="sf_admin_list_th_actions"
                style="width: 170px;text-align: center"><?php echo __('Actions', array(), 'tmcTwitterBootstrapPlugin') ?></th>
        </tr>
        </thead>
        ...
        <?php else: ?>
            ...
            <?php foreach ($results as $i => $ad_article): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
                ...
                <tr class="sf_admin_row <?php echo $odd ?> {pk: <?php echo $ad_article->getId() ?>}"
                    ...
                    <?php include_partial('adArticlesEditor/list_td_batch_actions', array('ad_article' => $ad_article, 'helper' => $helper)) ?>
            ...
            <tr>
                <th colspan="10">
                    <?php if ($pager->haveToPaginate()): ?>
                        <div
                            style="position: relative; width: auto; float:right"><?php include_partial('adArticlesEditor/pagination', array('pager' => $pager)) ?></div>
