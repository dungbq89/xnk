<div class="sf_admin_list">
    <table class="datatable table table-bordered table-striped" id="table_vt_manage_article_public"
        ...
        <?php else: ?>
            ...
            <?php foreach ($results as $i => $ad_article): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
                ...
                <tr class="sf_admin_row <?php echo $odd ?> {pk: <?php echo $ad_article->getId() ?>}"
                    ...
                    <?php include_partial('adArticlesPublish/list_td_batch_actions', array('ad_article' => $ad_article, 'helper' => $helper)) ?>
            ...
            <tr>
                <th colspan="9">
                    <?php if ($pager->haveToPaginate()): ?>
                        <div
                            style="position: relative; width: auto; float:right"><?php include_partial('adArticlesPublish/pagination', array('pager' => $pager)) ?></div>
