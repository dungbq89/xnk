<div class="sf_admin_list">
    <table class="datatable table table-bordered table-striped" id="table_sf_guard_permission" style="margin-top: 5px !important;">
      <thead>
          <tr>
                        <th id="sf_admin_list_batch_actions" style="width: 10px"></th>
      ...
      <!--   End thongnq1   -->
        <?php foreach ($results as $i => $sf_guard_permission): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>

          <tr class="sf_admin_row <?php echo $odd ?> {pk: <?php echo $sf_guard_permission->getId() ?>}" rel="<?php echo $sf_guard_permission->getId() ?>">
                ...
                <?php include_partial('sfGuardPermission/list_td_tabular', array('sf_guard_permission' => $sf_guard_permission, 'orderNo' => $orderNo)) ?>
      ...
      <tfoot>
        <tr>
          <th colspan="6">
            ...
            <div style="position: relative; width: auto; float:right"><?php include_partial('sfGuardPermission/pagination', array('pager' => $pager)) ?></div>
