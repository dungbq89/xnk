...
/**
 * AdDocumentDownload filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseAdDocumentDownloadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ad_document_download_filters[%s]');
